...
class TestAmenityInstantiation(unittest.TestCase):
    ...
    def test_two_amenities_different_created_at(self):
        """Test two amenities have different created_at"""
        amenity1 = Amenity()
        sleep(0.05)
        amenity2 = Amenity()
    ...
    def test_two_amenities_different_updated_at(self):
        """Test two amenities have different updated_at"""
        amenity1 = Amenity()
        sleep(0.05)
        amenity2 = Amenity()
    ...
    def test_args_unused(self):
        """Test unused args are not included in __dict__"""
...
class TestAmenitySave(unittest.TestCase):
    ...
    def test_two_saves(self):
        """Test save method called twice updates updated_at correctly"""
        amenity1 = Amenity()
        sleep(0.05)
        first_updated_at = amenity1.updated_at
        amenity1.save()
    ...
    def test_save_with_arg(self):
        """Test save method with argument raises TypeError"""
        amenity1 = Amenity()
        with self.assertRaises(TypeError):
            amenity1.save(None)

    def test_save_updates_file(self):
        """Test save method updates the file"""
        amenity1 = Amenity()
        amenity1.save()
...
class TestAmenityToDict(unittest.TestCase):
    ...
    def test_to_dict_datetime_attributes_are_strs(self):
        """Test datetime attributes are converted to strings in to_dict"""
        amenity1 = Amenity()
